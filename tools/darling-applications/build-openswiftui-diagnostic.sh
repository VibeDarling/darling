...
vd_overlay="$vd_src/darling-swift-swiftui-integration/overlays"
export VIBEDARLING_DARWIN_SWIFT_MODULES="${VIBEDARLING_DARWIN_SWIFT_MODULES:-$vd_overlay/build/modules}"
export VIBEDARLING_FOUNDATION_SWIFT_MODULES="${VIBEDARLING_FOUNDATION_SWIFT_MODULES:-$vd_overlay/build/modules}"
export VIBEDARLING_DARWIN_MODULEMAPS="${VIBEDARLING_DARWIN_MODULEMAPS:-$vd_overlay/shims/overlay-shims.modulemap:$vd_overlay/CoreGraphics/shims/module.modulemap}"
