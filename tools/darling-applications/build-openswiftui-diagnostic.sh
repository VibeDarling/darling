...
export VIBEDARLING_DARWIN_SWIFT_MODULES="$vd_src/swift-darling/overlays/out/modules"
export VIBEDARLING_FOUNDATION_SWIFT_MODULES="$vd_src/swift-darling/overlays/out-foundation-min/modules"
