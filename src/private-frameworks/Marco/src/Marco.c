...
/* Stub. As of 2026-09-20, these binaries link Marco but bind no symbol from it, so an
...
static void Marco_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: Marco loaded (no symbols implemented)\n");
}
