...
/* Stub. As of 2026-09-20, these binaries link AdPlatformsCommon but bind no symbol from it, so an
...
static void AdPlatformsCommon_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: AdPlatformsCommon loaded (no symbols implemented)\n");
}
