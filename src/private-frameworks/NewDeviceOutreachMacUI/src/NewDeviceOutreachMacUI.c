...
/* Stub. As of 2026-09-20, these binaries link NewDeviceOutreachMacUI but bind no symbol from it, so an
...
static void NewDeviceOutreachMacUI_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: NewDeviceOutreachMacUI loaded (no symbols implemented)\n");
}
