...
/* Stub. As of 2026-09-20, these binaries link TextComposer but bind no symbol from it, so an
...
static void TextComposer_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: TextComposer loaded (no symbols implemented)\n");
}
