...
/* Stub. As of 2026-09-20, these binaries link DeviceIdentity but bind no symbol from it, so an
...
static void DeviceIdentity_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: DeviceIdentity loaded (no symbols implemented)\n");
}
