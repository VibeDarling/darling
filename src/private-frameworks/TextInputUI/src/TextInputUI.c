...
/* Stub. As of 2026-09-20, these binaries link TextInputUI but bind no symbol from it, so an
...
static void TextInputUI_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: TextInputUI loaded (no symbols implemented)\n");
}
