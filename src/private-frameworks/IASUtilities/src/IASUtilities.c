...
/* Stub. As of 2026-09-20, these binaries link IASUtilities but bind no symbol from it, so an
...
static void IASUtilities_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: IASUtilities loaded (no symbols implemented)\n");
}
