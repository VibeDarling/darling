...
/* Stub. As of 2026-09-20, these binaries link StocksKit but bind no symbol from it, so an
...
static void StocksKit_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: StocksKit loaded (no symbols implemented)\n");
}
