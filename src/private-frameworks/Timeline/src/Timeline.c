...
/* Stub. As of 2026-09-20, these binaries link Timeline but bind no symbol from it, so an
...
static void Timeline_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: Timeline loaded (no symbols implemented)\n");
}
