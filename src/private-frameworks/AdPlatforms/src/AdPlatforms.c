...
/* Stub. As of 2026-09-20, these binaries link AdPlatforms but bind no symbol from it, so an
...
static void AdPlatforms_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: AdPlatforms loaded (no symbols implemented)\n");
}
