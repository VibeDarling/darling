...
/* Stub. As of 2026-09-20, these binaries link AppSSOCore but bind no symbol from it, so an
...
static void AppSSOCore_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: AppSSOCore loaded (no symbols implemented)\n");
}
