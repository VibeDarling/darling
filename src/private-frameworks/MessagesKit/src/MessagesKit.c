...
/* Stub. As of 2026-09-20, these binaries link MessagesKit but bind no symbol from it, so an
...
static void MessagesKit_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: MessagesKit loaded (no symbols implemented)\n");
}
