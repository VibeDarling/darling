...
/* Stub. As of 2026-09-20, these binaries link IdleTimerServices but bind no symbol from it, so an
...
static void IdleTimerServices_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: IdleTimerServices loaded (no symbols implemented)\n");
}
