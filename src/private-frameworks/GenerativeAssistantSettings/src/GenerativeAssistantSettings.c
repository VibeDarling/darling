...
/* Stub. As of 2026-09-20, these binaries link GenerativeAssistantSettings but bind no symbol from it, so an
...
static void GenerativeAssistantSettings_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: GenerativeAssistantSettings loaded (no symbols implemented)\n");
}
