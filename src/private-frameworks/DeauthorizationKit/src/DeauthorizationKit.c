...
/* Stub. As of 2026-09-20, these binaries link DeauthorizationKit but bind no symbol from it, so an
...
static void DeauthorizationKit_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: DeauthorizationKit loaded (no symbols implemented)\n");
}
