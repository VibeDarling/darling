...
/* Stub. As of 2026-09-20, these binaries link LinkServices but bind no symbol from it, so an
...
static void LinkServices_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: LinkServices loaded (no symbols implemented)\n");
}
