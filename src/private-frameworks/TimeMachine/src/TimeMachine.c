...
/* Stub. As of 2026-09-20, these binaries link TimeMachine but bind no symbol from it, so an
...
static void TimeMachine_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: TimeMachine loaded (no symbols implemented)\n");
}
