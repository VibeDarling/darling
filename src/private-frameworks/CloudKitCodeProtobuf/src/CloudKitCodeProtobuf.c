...
/* Stub. As of 2026-09-20, these binaries link CloudKitCodeProtobuf but bind no symbol from it, so an
...
static void CloudKitCodeProtobuf_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: CloudKitCodeProtobuf loaded (no symbols implemented)\n");
}
