...
/* Stub. As of 2026-09-20, these binaries link AppStoreUI but bind no symbol from it, so an
...
static void AppStoreUI_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: AppStoreUI loaded (no symbols implemented)\n");
}
