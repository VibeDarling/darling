...
/* Stub. As of 2026-09-20, these binaries link UserActivity but bind no symbol from it, so an
...
static void UserActivity_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: UserActivity loaded (no symbols implemented)\n");
}
