...
/* Stub. As of 2026-09-20, these binaries link SystemUIPlugin but bind no symbol from it, so an
...
static void SystemUIPlugin_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: SystemUIPlugin loaded (no symbols implemented)\n");
}
