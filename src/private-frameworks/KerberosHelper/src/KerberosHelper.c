...
/* Stub. As of 2026-09-20, these binaries link KerberosHelper but bind no symbol from it, so an
...
static void KerberosHelper_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: KerberosHelper loaded (no symbols implemented)\n");
}
