...
/* Stub. As of 2026-09-20, these binaries link HomeKitFeatures but bind no symbol from it, so an
...
static void HomeKitFeatures_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: HomeKitFeatures loaded (no symbols implemented)\n");
}
