...
/* Stub. As of 2026-09-20, these binaries link CoreParsec but bind no symbol from it, so an
...
static void CoreParsec_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: CoreParsec loaded (no symbols implemented)\n");
}
