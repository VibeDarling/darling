...
/* Stub. As of 2026-09-20, these binaries link FontServices but bind no symbol from it, so an
...
static void FontServices_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: FontServices loaded (no symbols implemented)\n");
}
