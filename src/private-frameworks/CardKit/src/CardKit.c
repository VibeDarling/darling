...
/* Stub. As of 2026-09-20, these binaries link CardKit but bind no symbol from it, so an
...
static void CardKit_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: CardKit loaded (no symbols implemented)\n");
}
