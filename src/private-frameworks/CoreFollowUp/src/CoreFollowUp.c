...
/* Stub. As of 2026-09-20, these binaries link CoreFollowUp but bind no symbol from it, so an
...
static void CoreFollowUp_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: CoreFollowUp loaded (no symbols implemented)\n");
}
