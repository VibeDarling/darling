...
/* Stub. As of 2026-09-20, these binaries link NewsAnalyticsUpload but bind no symbol from it, so an
...
static void NewsAnalyticsUpload_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: NewsAnalyticsUpload loaded (no symbols implemented)\n");
}
