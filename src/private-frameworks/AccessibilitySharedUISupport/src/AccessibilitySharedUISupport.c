...
/* Stub. As of 2026-09-20, these binaries link AccessibilitySharedUISupport but bind no symbol from it, so an
...
static void AccessibilitySharedUISupport_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: AccessibilitySharedUISupport loaded (no symbols implemented)\n");
}
