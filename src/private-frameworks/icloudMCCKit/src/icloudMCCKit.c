...
/* Stub. As of 2026-09-20, these binaries link icloudMCCKit but bind no symbol from it, so an
...
static void icloudMCCKit_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: icloudMCCKit loaded (no symbols implemented)\n");
}
