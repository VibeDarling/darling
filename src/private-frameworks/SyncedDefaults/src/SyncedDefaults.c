...
/* Stub. As of 2026-09-20, these binaries link SyncedDefaults but bind no symbol from it, so an
...
static void SyncedDefaults_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: SyncedDefaults loaded (no symbols implemented)\n");
}
