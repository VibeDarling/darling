...
/* Stub. As of 2026-09-20, these binaries link PhoneNumbers but bind no symbol from it, so an
...
static void PhoneNumbers_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: PhoneNumbers loaded (no symbols implemented)\n");
}
