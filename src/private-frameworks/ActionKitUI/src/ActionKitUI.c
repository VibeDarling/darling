...
/* Stub. As of 2026-09-20, these binaries link ActionKitUI but bind no symbol from it, so an
...
static void ActionKitUI_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: ActionKitUI loaded (no symbols implemented)\n");
}
