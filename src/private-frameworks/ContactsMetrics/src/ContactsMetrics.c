...
/* Stub. As of 2026-09-20, these binaries link ContactsMetrics but bind no symbol from it, so an
...
static void ContactsMetrics_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: ContactsMetrics loaded (no symbols implemented)\n");
}
