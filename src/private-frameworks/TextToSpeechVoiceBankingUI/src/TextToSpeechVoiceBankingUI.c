...
/* Stub. As of 2026-09-20, these binaries link TextToSpeechVoiceBankingUI but bind no symbol from it, so an
...
static void TextToSpeechVoiceBankingUI_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: TextToSpeechVoiceBankingUI loaded (no symbols implemented)\n");
}
