...
/* Stub. As of 2026-09-20, these binaries link AVConference but bind no symbol from it, so an
...
static void AVConference_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: AVConference loaded (no symbols implemented)\n");
}
