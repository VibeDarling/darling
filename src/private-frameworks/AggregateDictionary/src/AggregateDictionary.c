...
/* Stub. As of 2026-09-20, these binaries link AggregateDictionary but bind no symbol from it, so an
...
static void AggregateDictionary_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: AggregateDictionary loaded (no symbols implemented)\n");
}
