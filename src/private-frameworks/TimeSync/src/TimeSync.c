...
/* Stub. As of 2026-09-20, these binaries link TimeSync but bind no symbol from it, so an
...
static void TimeSync_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: TimeSync loaded (no symbols implemented)\n");
}
