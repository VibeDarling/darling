...
/* Stub. As of 2026-09-20, these binaries link AOSAccounts but bind no symbol from it, so an
...
static void AOSAccounts_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: AOSAccounts loaded (no symbols implemented)\n");
}
