...
/* Stub. As of 2026-09-20, these binaries link QueryParser but bind no symbol from it, so an
...
static void QueryParser_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: QueryParser loaded (no symbols implemented)\n");
}
