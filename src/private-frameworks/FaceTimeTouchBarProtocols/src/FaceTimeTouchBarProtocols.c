...
/* Stub. As of 2026-09-20, these binaries link FaceTimeTouchBarProtocols but bind no symbol from it, so an
...
static void FaceTimeTouchBarProtocols_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: FaceTimeTouchBarProtocols loaded (no symbols implemented)\n");
}
