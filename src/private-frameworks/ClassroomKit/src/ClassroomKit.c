...
/* Stub. As of 2026-09-20, these binaries link ClassroomKit but bind no symbol from it, so an
...
static void ClassroomKit_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: ClassroomKit loaded (no symbols implemented)\n");
}
