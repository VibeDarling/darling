...
/* Stub. As of 2026-09-20, these binaries link MediaExperience but bind no symbol from it, so an
...
static void MediaExperience_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: MediaExperience loaded (no symbols implemented)\n");
}
