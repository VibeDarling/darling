...
/* Stub. As of 2026-09-20, these binaries link CoreCDP but bind no symbol from it, so an
...
static void CoreCDP_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: CoreCDP loaded (no symbols implemented)\n");
}
