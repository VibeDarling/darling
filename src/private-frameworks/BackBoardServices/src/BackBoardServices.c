...
/* Stub. As of 2026-09-20, these binaries link BackBoardServices but bind no symbol from it, so an
...
static void BackBoardServices_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: BackBoardServices loaded (no symbols implemented)\n");
}
