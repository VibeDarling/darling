...
/* Stub. As of 2026-09-20, these binaries link IntentsFoundation but bind no symbol from it, so an
...
static void IntentsFoundation_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: IntentsFoundation loaded (no symbols implemented)\n");
}
