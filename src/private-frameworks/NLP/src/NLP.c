...
/* Stub. As of 2026-09-20, these binaries link NLP but bind no symbol from it, so an
...
static void NLP_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: NLP loaded (no symbols implemented)\n");
}
