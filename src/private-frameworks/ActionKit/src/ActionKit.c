...
/* Stub. As of 2026-09-20, these binaries link ActionKit but bind no symbol from it, so an
...
static void ActionKit_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: ActionKit loaded (no symbols implemented)\n");
}
