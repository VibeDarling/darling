...
/* Stub. As of 2026-09-20, these binaries link UserNotificationsUI but bind no symbol from it, so an
...
static void UserNotificationsUI_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: UserNotificationsUI loaded (no symbols implemented)\n");
}
