...
/* Stub. As of 2026-09-20, these binaries link NotificationCenter but bind no symbol from it, so an
...
static void NotificationCenter_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: NotificationCenter loaded (no symbols implemented)\n");
}
