...
extern const CFStringRef kMIDIPropertyUMPActiveGroupBitmap        API_AVAILABLE(macos(14.0));
extern const CFStringRef kMIDIPropertyUMPCanTransmitGroupless     API_AVAILABLE(macos(14.0));
