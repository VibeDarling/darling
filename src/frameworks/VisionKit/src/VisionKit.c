...
/* Stub. As of 2026-09-20, these binaries link VisionKit but bind no symbol from it, so an
...
static void VisionKit_stub_loaded(void)
{
	if (getenv("STUB_VERBOSE"))
		fprintf(stderr, "STUB: VisionKit loaded (no symbols implemented)\n");
}
